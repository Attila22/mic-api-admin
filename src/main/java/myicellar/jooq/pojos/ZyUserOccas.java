...
public final class ZyUserOccas implements Serializable {

	private static final long serialVersionUID = -1985312621;
	...
	public String toString() {
		StringBuilder sb = new StringBuilder("ZyUserOccas (");
