...
public final class AttrAbvintage implements Serializable {

	private static final long serialVersionUID = 124315103;
	...
	public String toString() {
		StringBuilder sb = new StringBuilder("AttrAbvintage (");
