...
public final class ZyAttrAbnote implements Serializable {

	private static final long serialVersionUID = 741991057;
	...
	public String toString() {
		StringBuilder sb = new StringBuilder("ZyAttrAbnote (");
