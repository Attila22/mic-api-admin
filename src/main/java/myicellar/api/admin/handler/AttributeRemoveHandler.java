 ...
 */
public class AttributeRemoveHandler implements Handler{
        ...
        ctx.parse(Jackson.jsonNode())
                ...
                .blockingMap(pair -> {
                    ...
                    try (Connection connection = ctx.get(DataSource.class).getConnection()) {
                        ...
                        {
                            return VintageQtil.removeVintageAttribute(dslContext, pair.right.getWineId(), pair.right.getVintageTag(), pair.right.getAttrId()).execute();
