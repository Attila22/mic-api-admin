 ...
 */
public class VintageUpdate implements Handler{
            ...
            ctx.parse(Jackson.jsonNode())
                    ...
                    .blockingMap(pair -> {
                        ...
                        try (Connection connection = ctx.get(DataSource.class).getConnection()) {
                            ...
                            {
                                return VintageQtil.updateVintageDetail(dslContext, pair.right.getWineId(), pair.right.getVintageTag(), pair.right.getVintageName(), pair.right.getIsValid()).execute();
